const projectsData = [
  {
    ...
    description:
      "Introduce a cutting-edge website. I’ve developed using Next.js,where anyone can create stunning AI-generated short videos in just 3 simple steps.",
    image: "/images/projects/ai-videos/ai-video-cover.jpg",
    tag: ["All", "Web2.0"],
    gitUrl: "https://ai-shortvideo.netlify.app/",
    previewUrl: "/",
    images: ["/images/projects/ai-videos/ai-video-cover.jpg"],
  },
  {
    id: 6,
    title: "Car Marketplace",
    description:
      "I have built a car marketplace using React and PostgreSQL with secure authentication powered by Clerk. Buyers and sellers can list cars, chat in real-time, and share text or images. Check it out!",
    image: "/images/projects/car/car1.jpeg",
    tag: ["All", "Web2.0"],
    gitUrl: "https://alrehmanai-car-gala.vercel.app/",
    previewUrl: "/",
    images: ["/images/projects/car/car1.jpeg"],
  },
  {
    id: 11,
    title: "Blockchain dApp on ICP",
    description:
      "My very own crypto token, developed using the Motoko backend on the Internet Computer Protocol (ICP) and a React frontend. With this app, you can: 💎 Get hands-on experience with my tokens 🌐 Explore the potential of ICP’s decentralized ecosystem 🔐 Enjoy secure and scalable blockchain solutions",
    image: "/images/projects/blockchain/my-token.PNG",
    tag: ["All", "Web3.0"],
    gitUrl: "https://7xudm-viaaa-aaaai-q3lba-cai.icp0.io/",
    previewUrl: "/",
    images: ["/images/projects/blockchain/my-token.PNG"],
  },
  {
    id: 1,
